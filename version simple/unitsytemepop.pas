...
// on devra construire des églises et centres villes en fonction du nombre d'habitants
...
//la production de ressources dépend du nombre de bâtiment permettant la fabriquation de cette ressource
