...
begin
  ...
  begin
    ...
    writeln('          Mais si votre ile est assez developpe, alors n''hesitez pas et lancez vous a l''aventure');
    ...
    writeln('          Ces navires devront eux aussi être accompagnés  de soldats, je pense que 50 soldats suffiront.');
